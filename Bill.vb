...
Public Class frmHD
    ...
    Public Sub LoadData()
        ...
        Dim SP As New SqlDataAdapter("Select * from HoaDon", KN)
        Try
            SP.Fill(TB)
    ...
    Private Sub frmHD_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim KN As New SqlConnection(chuoiKN)
        Dim loai As New SqlDataAdapter("Select * from HoaDon", KN)
        Try
            KN.Open()
            'Nhập dữ liệu
            loai.Fill(TB)
    ...
    Private Sub btnthem_Click(sender As Object, e As EventArgs) Handles btnthem.Click
        ...
        Dim DL As String = "Insert into HoaDon Values (@MaHD, @KhachHang_MaKH, @MaSP, @TongHD, @NgayIn)"
        ...
        Try
            ...
            them.Parameters.AddWithValue("@KhachHang_MaKH", txt1.Text)
            them.Parameters.AddWithValue("@MaSP", txt2.Text)
            them.Parameters.AddWithValue("@TongHD", txt3.Text)
            them.Parameters.AddWithValue("@NgayIn", txt4.Text)
    ...
    Private Sub btnsua_Click(sender As Object, e As EventArgs) Handles btnsua.Click
        ...
        KN.Open()
        'sữa dữ liệu
        Dim DL As String = "Update HoaDon Set MaHD = @MaHD, KhachHang_MaKH = @KhachHang_MaKH, MaSP = @MaSP, TongHD = @TongHD, NgayIn = @NgayIn"
        Dim them As New SqlCommand(DL, KN)
        Try
            'Thêm Dữ Liệu
            them.Parameters.AddWithValue("@MaHD", txt0.Text)
    ...
    Private Sub btnxoa_Click(sender As Object, e As EventArgs) Handles btnxoa.Click
        Dim KN As New SqlConnection(chuoiKN)
        KN.Open()
        Dim DL As String = "Delete from HoaDon Where MaHD = @MaHD"
